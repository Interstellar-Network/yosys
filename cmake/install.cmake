...
# TODO why does SHLIBDEPS not list the deps on Arch?
# TODO version? eg "libc6 (>= 2.3.1-6), libc6 (< 2.4)")
set(CPACK_DEBIAN_PACKAGE_DEPENDS "tcl-dev, libreadline-dev")
...
install(TARGETS sha1 ARCHIVE DESTINATION lib)
install(TARGETS yosys_exe RUNTIME DESTINATION bin RENAME yosys)

# TODO why can json11 and sha1 not be auto detected?
install(TARGETS json11 ARCHIVE DESTINATION lib)
